...
const inventors16thCentury = inventors.filter((inventor) => {
  return inventor.passed < 1700 && inventor.passed > 1600;
});

console.log(inventors16thCentury);
...
const inventorBirthYear = inventors.map((inventor) => {
  return inventor.year;
});

console.log(inventorBirthYear);
...
inventors.sort((a,b) => {
  const inventorLifeA = a.passed - a.year
  const inventorLifeB = b.passed - b.year
  return inventorLifeB - inventorLifeA
});
...
const findInventor = inventors.find((inventor) => {
  return inventor.last === "Edison"
});

console.log(findInventor);